> **Goal v3 activo; entrega pendiente — sólo auditoría y propuesta de desarrollo.** El [inventario factual](../modeling/financial-v3/audit-summary.json), [consultas/hashes](../modeling/financial-v3/audit.json) y [diseño V3T2](../modeling/financial-v3/design-proposal.md) separan caja retrospectiva de inputs as-of, exigen evidencia de obligaciones/pagos y no premiar el impago, y dejan score agregado null cuando faltan inputs esenciales. Los valores propuestos son decisiones de desarrollo, no aprendidas ni validadas por negocio. No se ha identificado reserva confirmatoria intacta: los 50 grupos final_test v1 siguen excluidos y la reserva v2 está consumida; hacen falta datos futuros/externos con disponibilidad y acceso trazables. No se han ejecutado modelos, etiquetas ni evaluación v3. Todo el preregistro, resultados y texto v1/v2 de abajo se preserva íntegro como contrato histórico; no autoriza reabrirlos ni implica que v3 o sus seis preguntas estén resueltos.

# Plan de desarrollo: scoring financiero y predicción temporal

## Estado actual y Goal v2
