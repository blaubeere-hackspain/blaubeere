...
export function AssistantSection() {
  ...
  return <section className="assistant-section site-container" id="assistants" aria-labelledby="assistant-title">
    <div className="assistant-painting" data-scroll-reveal id="assistant-artwork">
    ...
    <div className="assistant-copy">
      <div className="assistant-intro" data-scroll-reveal><h2 id="assistant-title">A second perspective.<br/><span>The same clear picture.</span></h2><p>MCP connects blau to the AI assistant you already use. Bring your company’s financial context into the conversation, and ask questions in your own words.</p></div>
      <ul className="assistant-features" data-scroll-reveal aria-label="Explore assistant features">
      ...
      <div className="assistant-actions" data-scroll-reveal><a className="button" href={`${appOrigin}/dashboard`}>Connect your assistant<ArrowRight size={16} aria-hidden/></a><p className="assistant-note">For assistants that support remote MCP and OAuth. You approve access and can revoke it anytime. No source edits or payments.</p></div>
    </div>
  </section>;
}
