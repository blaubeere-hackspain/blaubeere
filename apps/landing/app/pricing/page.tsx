  ...
  return <>
    ...
    <main id="main" className="pricing-main">
      ...
      <section className="pricing-comparison site-container" id="features" aria-labelledby="comparison-title">
        <div className="section-intro" data-scroll-reveal><span className="eyebrow">What’s in your plan</span><h2 id="comparison-title">The details, side by side.</h2><p>The essentials in both plans. Enterprise starts with a conversation about how your team works.</p></div>
        <table className="pricing-table" data-scroll-reveal>
      ...
      <p className="pricing-demo site-container" data-scroll-reveal>A little look before your next move.<a className="text-link" href={`${appOrigin}/login`}>Explore the demo<ArrowRight size={16} aria-hidden/></a></p>
    </main>
    <SiteFooter/>
  </>;
}
