...
export function Planner({ company, example, open, onClose, onCompare, onPreview }: { company: Company; example?: Comparison; open: boolean; onClose: () => void; onCompare: (c: Comparison) => void; onPreview: (p?: Plan) => void }) {
