...
export function LoginForm({ register = false, returnTo }: { register?: boolean; returnTo?: string }) {
  ...
  return <div className="auth-form">
    <div><span className="badge accent"><LockKeyhole size={14} aria-hidden/>Your finance workspace</span><h1 className="mt-4">{register ? "A clearer start." : "Welcome back."}</h1><p className="muted">{register ? "Create your account. Your team can then grant access to your company’s data." : "Sign in to see your company’s cash outlook."}</p></div>
