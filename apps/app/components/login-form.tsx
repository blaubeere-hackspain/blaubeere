...
export function LoginForm() {
  ...
  return <div className="auth-form">
    ...
    <form onSubmit={submit} aria-busy={busy}>
      ...
      <button type="submit" className="button" disabled={busy}>{busy ? <><LoaderCircle className="spinner" aria-hidden/>Signing in…</> : <>Sign in<ArrowRight size={16} aria-hidden/></>}</button>
    </form>
